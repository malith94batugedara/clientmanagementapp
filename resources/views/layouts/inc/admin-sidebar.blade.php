    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a href="{{ route('admin.client') }}" class="nav-link {{ Request::is('admin/client') ? 'collapse active' : 'collapsed' ;}}" >
                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                    Clients
                    {{-- <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div> --}}
                </a>
                {{-- <div class="collapse {{ Request::is('admin/client') ? 'show' : '' ;}} || {{ Request::is('admin/add-category') ? 'show' : '';}} || {{ Request::is('admin/edit-category/*') ? 'show' : ''}}" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link {{ Request::is('admin/client') ? 'active' : '';}}" href="{{ route('admin.client') }}">Add Category</a>
